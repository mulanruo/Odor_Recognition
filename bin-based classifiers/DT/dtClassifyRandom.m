function [train_accu, test_accu] = dtClassifyRandom(dataSet, dataLabel, class)
    fold = 5;
    sampleSize = 20;
...
%     accuracy = 1 - classLoss;
    for i = 1:1:iter
        ...
        DT_model = fitctree(train_data, train_label);
        
        predict_label = predict(DT_model, train_data);
        ...
        predict_label = predict(DT_model, test_data);
