function [train_accu, test_accu] = svmClassifyRandom(dataSet, dataLabel, class)
    fold = 5;
    sampleSize = 20;
...
%     accuracy = 1 - classLoss;
    for i = 1:1:iter
        ...
        SVM_model = fitcecoc(train_data, train_label, 'Learners', t);
        
        predict_label = predict(SVM_model, train_data);
