function [train_accu, test_accu] = daClassifyRandom(dataSet, dataLabel, class)
    fold = 5;
    sampleSize = 20;
...
%     accuracy = 1 - classLoss;
    for i = 1:1:iter
        ...
        DA_model = fitcdiscr(train_data, train_label);
        
        predict_label = predict(DA_model, train_data);
        ...
        predict_label = predict(DA_model, test_data);
